...
//import books.data.MemberRepository;
//import books.rest.MemberService;
//import books.service.MemberRegistration;
...
//import books.util.Resources;
//
///**
// * Uses Arquilian to test the JAX-RS processing class for books manipulations.
// *
// * @author balunasj
// */
...
//                .addClasses(Book.class, BookController.class, Resources.class)
...
//        Book book = createBookInstance("Jack Doe book", "Jack Doe");
//        Response response = bookController.saveOrUpdate(book);
//        assertEquals("Response status", 200, response.getStatus());
//        log.info(" New book was persisted and returned status " + response.getStatus());
//    }
//
//    private Book createBookInstance(String title, String author) {
//        Book book = new Book();
//        book.setTitle(title);
